...
#define EENV_ROMSTART                               (0x08100000)
#define EENV_ROMSIZE                                (1024*1024)

#define EENV_RAMSTART                               (0x10000000)
...
#elif ((EENV_MEMMAP_SHARSERV_BASE_RAMADDR) == 0x1001FFC0)
#define EENV_SHARSERV_BASE_RAMADDR_AT ".ARM.__at_0x1001FFC0"
#else
...
// --- eloader: 128k [0x08100000, 0x08100000 + 0x00020000 = 0x08120000]
...
#if ((EENV_MEMMAP_ELOADER_ROMADDR+EENV_MODULEINFO_OFFSET) == 0x08100400)
...
// --- eupdater: 256K [0x08120000, 0x08120000 + 0x00040000 = 0x08160000]
...
#if ((EENV_MEMMAP_EUPDATER_ROMADDR+EENV_MODULEINFO_OFFSET) == 0x08120400)
...
// --- eapplication: 512K [0x08160000, 0x08160000 + 0x00080000 = 0x081E0000]
...
#if ((EENV_MEMMAP_EAPPLICATION_ROMADDR+EENV_MODULEINFO_OFFSET) == 0x08160400)
#define EENV_MODULEINFO_APPLICATION_AT ".ARM.__at_0x08160400"
#else
