...
static void s_led_countdown_start(void)
{
    ...
    eo_action_SetCallback(s_action_led, s_toggle_led, NULL, eov_callbackman_GetTask(eov_callbackman_GetHandle()));
...
//    hal_led_toggle(hal_led5);
    ...
    embot::hw::led::toggle(embot::hw::LED::two);
...
//    hal_led_off(hal_led5);
    ...
    embot::hw::led::off(embot::hw::LED::two);   
    embot::hw::led::off(embot::hw::LED::three); 
    embot::hw::led::off(embot::hw::LED::four);
    embot::hw::led::off(embot::hw::LED::five); 
    embot::hw::led::off(embot::hw::LED::six);
    
    eo_action_SetCallback(s_action_led, s_toggle_led_cangtw, NULL, eov_callbackman_GetTask(eov_callbackman_GetHandle()));
