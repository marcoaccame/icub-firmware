...
namespace embot::app::board::amc1cm7::info { 
    ...
    #define INFO32 "i am an amc1cm7 @ ICC1:3/CAN2:3"
#else
                 // 0123456789abcde0123456789abcde
    #define INFO32 "i am an amc1cm7 @ CAN2:3"
#endif    
...
namespace embot::app::board::amc1cm7::info {
    ...
    embot::app::application::CANagentCORE* getCANgentCORE()
    {
        ...
        if(!initted)
        {
            ...
            embot::app::board::amc1cm7::theCANagentCORE::getInstance().initialise({theboard, applInfo, location, info32});
            initted = true;
        }
        return &embot::app::board::amc1cm7::theCANagentCORE::getInstance();
    }
    ...
    .moduleinfo     =
    {
        .info           =
        {
            .entity     =
            {
                ...
                .version    = 
                { 
                    .major = embot::app::board::amc1cm7::info::signature.application.major, 
                    .minor = embot::app::board::amc1cm7::info::signature.application.minor
                },  
                .builddate  = 
                {
                    .year  = embot::app::board::amc1cm7::info::signature.date.year,
                    .month = embot::app::board::amc1cm7::info::signature.date.month,
                    .day   = embot::app::board::amc1cm7::info::signature.date.day,
                    .hour  = embot::app::board::amc1cm7::info::signature.date.hour,
                    .min   = embot::app::board::amc1cm7::info::signature.date.minute
                }
            },
            .rom        = 
            {   
...
void force_placement_of_flashmappedinfo()
{
    ...
    std::memmove(&sig, &embot::app::board::amc1cm7::info::signature, sizeof(sig));     
}
