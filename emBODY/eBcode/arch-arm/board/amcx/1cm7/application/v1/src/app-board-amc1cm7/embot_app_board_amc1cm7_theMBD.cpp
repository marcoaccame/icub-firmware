...
#include "embot_app_board_amc1cm7_theMBD.h"
...
namespace embot::app::board::amc1cm7 {
...
struct embot::app::board::amc1cm7::theMBD::Impl
{
...
bool embot::app::board::amc1cm7::theMBD::Impl::initialise(const Config &config)
{
    if(true == initted)
    {
        return true;
    ...
    embot::core::print("embot::app::board::amc1cm7::theMBD::Impl::initialise()");
    ...
    buttonEXTfault = embot::hw::bsp::amc1cm7::EXTFAULTbutton();
    ledEXTfault = embot::hw::bsp::amc1cm7::EXTFAULTled();
...
void embot::app::board::amc1cm7::theMBD::Impl::onEXTFAULTpolling()
{
...
void embot::app::board::amc1cm7::theMBD::Impl::onEXTFAULTpressedreleased(void *owner)
{
...
// Called every 1 ms
bool embot::app::board::amc1cm7::theMBD::Impl::tick(const std::vector<embot::app::bldc::MSG> &inputmessages, std::vector<embot::app::bldc::MSG> &outputmessages)
{     
...
void embot::app::board::amc1cm7::theMBD::Impl::onCurrents_FOC_innerloop(void *owner, const embot::hw::motor::Currents * const currents)
{
    Impl * impl = reinterpret_cast<Impl*>(owner);
...
#ifdef PRINT_HISTO_DEBUG 
void embot::app::board::amc1cm7::theMBD::Impl::printHistogram_rxPkt(size_t cur_size)
{
...
embot::app::board::amc1cm7::theMBD& embot::app::board::amc1cm7::theMBD::getInstance()
{
    static theMBD* p = new theMBD();
    return *p;
}

embot::app::board::amc1cm7::theMBD::theMBD()
{
...
bool embot::app::board::amc1cm7::theMBD::initialise(const Config &config)
{
    return pImpl->initialise(config);
}

bool embot::app::board::amc1cm7::theMBD::tick(const std::vector<embot::app::bldc::MSG> &inputmessages, std::vector<embot::app::bldc::MSG> &outputmessages)
{
