...
namespace embot::app::board::amc1cm7::mbd {
...
#else
        embot::app::board::amc1cm7::theMBD::getInstance().initialise({adr});          
#endif        
...
#else
        embot::app::board::amc1cm7::theMBD::getInstance().tick(input, output);    
#endif   
