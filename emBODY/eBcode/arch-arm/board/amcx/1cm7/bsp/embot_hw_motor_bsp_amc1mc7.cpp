...
namespace embot::hw::motor::bsp::amc1cm7 {
...
//        /* USER CODE END TIM1_Init 0 */
        ...
        hTIM1.Init.Period = embot::hw::motor::bsp::amc1cm7::PWMvals.TIM1_period; // 2000; // 1219;
        ...
        sConfigOC.Pulse = embot::hw::motor::bsp::amc1cm7::PWMvals.TIM1_ocPulse ; // 1469; //895; // was 752, changed due to different clock source from amc-bldc
...
extern "C" {
    ...
    {
        HAL_ADC_IRQHandler(&embot::hw::motor::bsp::amc1cm7::hADC1);
        HAL_ADC_IRQHandler(&embot::hw::motor::bsp::amc1cm7::hADC2);
#if defined(EMBOT_ENABLE_hw_analog_ish)        
        HAL_ADC_IRQHandler(&embot::hw::motor::bsp::amc1cm7::hADC3);
#endif
    }   
    ...
    {
        HAL_DMA_IRQHandler(&embot::hw::motor::bsp::amc1cm7::hdma_adc1);
    }
    ...
    {
        HAL_DMA_IRQHandler(&embot::hw::motor::bsp::amc1cm7::hdma_adc3);
    }
#endif
    ...
    void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
    {
        ...
        if(hadc->Instance==ADC1)
        {
            ...
            */
            ...
            /* ADC1 DMA Init */
            /* ADC1 Init */
            embot::hw::motor::bsp::amc1cm7::hdma_adc1.Instance = DMA2_Stream0;
            embot::hw::motor::bsp::amc1cm7::hdma_adc1.Init.Request = DMA_REQUEST_ADC1;
            embot::hw::motor::bsp::amc1cm7::hdma_adc1.Init.Direction = DMA_PERIPH_TO_MEMORY;
            embot::hw::motor::bsp::amc1cm7::hdma_adc1.Init.PeriphInc = DMA_PINC_DISABLE;
            embot::hw::motor::bsp::amc1cm7::hdma_adc1.Init.MemInc = DMA_MINC_ENABLE;
            embot::hw::motor::bsp::amc1cm7::hdma_adc1.Init.PeriphDataAlignment = DMA_PDATAALIGN_WORD;
            embot::hw::motor::bsp::amc1cm7::hdma_adc1.Init.MemDataAlignment = DMA_MDATAALIGN_WORD;
            embot::hw::motor::bsp::amc1cm7::hdma_adc1.Init.Mode = DMA_CIRCULAR;
            embot::hw::motor::bsp::amc1cm7::hdma_adc1.Init.Priority = DMA_PRIORITY_HIGH;
            embot::hw::motor::bsp::amc1cm7::hdma_adc1.Init.FIFOMode = DMA_FIFOMODE_DISABLE;
            if (HAL_DMA_Init(&embot::hw::motor::bsp::amc1cm7::hdma_adc1) != HAL_OK)
            {
                embot::hw::motor::bsp::amc1cm7::Error_Handler();
            }

            __HAL_LINKDMA(hadc,DMA_Handle,embot::hw::motor::bsp::amc1cm7::hdma_adc1);
        ...
        /* USER CODE END ADC3_MspInit 0 */
          /* ADC3 clock enable */
            ...
            */
            ...
            /* ADC3 DMA Init */
            /* ADC3 Init */
            embot::hw::motor::bsp::amc1cm7::hdma_adc3.Instance = DMA1_Stream4;
            embot::hw::motor::bsp::amc1cm7::hdma_adc3.Init.Request = DMA_REQUEST_ADC3;
            embot::hw::motor::bsp::amc1cm7::hdma_adc3.Init.Direction = DMA_PERIPH_TO_MEMORY;
            embot::hw::motor::bsp::amc1cm7::hdma_adc3.Init.PeriphInc = DMA_PINC_DISABLE;
            embot::hw::motor::bsp::amc1cm7::hdma_adc3.Init.MemInc = DMA_MINC_ENABLE;
            embot::hw::motor::bsp::amc1cm7::hdma_adc3.Init.PeriphDataAlignment = DMA_PDATAALIGN_HALFWORD;
            embot::hw::motor::bsp::amc1cm7::hdma_adc3.Init.MemDataAlignment = DMA_MDATAALIGN_HALFWORD;
            embot::hw::motor::bsp::amc1cm7::hdma_adc3.Init.Mode = DMA_CIRCULAR;
            embot::hw::motor::bsp::amc1cm7::hdma_adc3.Init.Priority = DMA_PRIORITY_MEDIUM;
            embot::hw::motor::bsp::amc1cm7::hdma_adc3.Init.FIFOMode = DMA_FIFOMODE_DISABLE;
            if (HAL_DMA_Init(&embot::hw::motor::bsp::amc1cm7::hdma_adc3) != HAL_OK)
            {
              for(;;); // Error_Handler();
            }
          
            __HAL_LINKDMA(hadc,DMA_Handle,embot::hw::motor::bsp::amc1cm7::hdma_adc3);
...
extern "C" {
    ...
    void TIM1_BRK_IRQHandler(void)
    {
        ...
        for(;;);
#else        
        HAL_TIM_IRQHandler(&embot::hw::motor::bsp::amc1cm7::hTIM1);
#endif
    }
    ...
    {
        HAL_TIM_IRQHandler(&embot::hw::motor::bsp::amc1cm7::hTIM4);
    }
    
    // TIM5 global interrupt
    void TIM5_IRQHandler(void)
    {
        HAL_TIM_IRQHandler(&embot::hw::motor::bsp::amc1cm7::hTIM5);
    }
    ...
    - embot::hw::motor::bsp::amc1cm7::TIM_base_MspInit()
    - embot::hw::motor::bsp::amc1cm7::TIM_base_MspDeInit()
#endif
